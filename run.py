...
DATA_PATH = {
    'mnre': {'train': '../HVPNeT-main/data/RE_data/txt/ours_train.txt',
             'dev': '../HVPNeT-main/data/RE_data/txt/ours_val.txt',
             'test': '../HVPNeT-main/data/RE_data/txt/ours_test.txt',
             'train_auximgs': '../HVPNeT-main/data/RE_data/txt/mre_train_dict.pth',  # {data_id : object_crop_img_path}
             'dev_auximgs': '../HVPNeT-main/data/RE_data/txt/mre_dev_dict.pth',
             'test_auximgs': '../HVPNeT-main/data/RE_data/txt/mre_test_dict.pth',
             'train_img2crop': '../HVPNeT-main/data/RE_data/img_detect/train/train_img2crop.pth',
             'dev_img2crop': '../HVPNeT-main/data/RE_data/img_detect/val/val_img2crop.pth',
             'test_img2crop': '../HVPNeT-main/data/RE_data/img_detect/test/test_img2crop.pth'},
}

IMG_PATH = {
    'mnre': {'train': '../HVPNeT-main/data/RE_data/img_org/train/',
             'dev': '../HVPNeT-main/data/RE_data/img_org/val/',
             'test': '../HVPNeT-main/data/RE_data/img_org/test'},
}

AUX_PATH = {
    'mnre': {
        'train': '../HVPNeT-main/data/RE_data/img_vg/train/crops',
        'dev': '../HVPNeT-main/data/RE_data/img_vg/val/crops',
        'test': '../HVPNeT-main/data/RE_data/img_vg/test/crops'
    },
}
...
def parse_argument():
    ...
    parser.add_argument('--current_round', default=6, type=int, help="current round of AL training")
    parser.add_argument('--initial_query_budget', default=2000, type=int, help="initial query budget")
...
def init_and_train_bert_vit_re(args, logger):
    ...
    if args.do_train:
        re_data_path, img_path, aux_path = DATA_PATH[args.dataset_name], IMG_PATH[args.dataset_name], AUX_PATH[
            args.dataset_name]
        re_path = '../HVPNeT-main/data/RE_data/ours_rel2id.json'
        ...
        task_model_logging_path = './ckpt/task_model'
        ...
        datamodule = MultiModalDataModule(processor, img_path, aux_path, args.max_seq, aux_size=args.aux_size,
                                          root_dir='../HVPNeT-main/data/RE_data/txt',rcnn_size=args.rcnn_size,
                                          batch_size=args.batch_size, num_workers=args.num_workers,write_path=args.write_path, do_test=args.do_test)
        ...
        # mm_probs, z1, z2, contribution_m1, contribution_m2 = trainer.predict(
        ...
        # contribution_m2 = contribution_m2.gather(1, torch.argmax(mm_probs, dim=-1, keepdim=True))
        #
        # avg_contribution_m1 = contribution_m1.mean()
        # avg_contribution_m2 = contribution_m2.mean()
        # print(f"avg_contribution_m1: {avg_contribution_m1}, avg_contribution_m2: {avg_contribution_m2}")
